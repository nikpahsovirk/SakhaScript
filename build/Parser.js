...
var UnarOperandNode_1 = __importDefault(require("./AST/UnarOperandNode"));
var Parser = /** @class */ (function () {
    ...
    Parser.prototype.parsePrint = function () {
        ...
        if (operatorLog != null) {
            return new UnarOperandNode_1.default(operatorLog, this.parseFormula());
        }
        throw new Error("\u041E\u0436\u0438\u0434\u0430\u0435\u0442\u0441\u044F \u0443\u043D\u0430\u0440\u043D\u044B\u0439 \u043E\u043F\u0435\u0440\u0430\u0442\u043E\u0440 \u041A\u041E\u041D\u0421\u041E\u041B\u042C \u0438\u043B\u0438 \u0447\u0438\u0441\u043B\u043E \u043D\u0430 \u043F\u043E\u0437\u0438\u0446\u0438\u0438 " + this.pos);
    };
    ...
    Parser.prototype.parseExpression = function () {
        ...
        throw new Error("\u041F\u043E\u0441\u043B\u0435 \u043F\u0435\u0440\u0435\u043C\u0435\u043D\u043D\u043E\u0439 \u043E\u0436\u0438\u0434\u0430\u0435\u0442\u0441\u044F \u0437\u043D\u0430\u043A \u043F\u0440\u0438\u0441\u0432\u043E\u0435\u043D\u0438\u044F \u043D\u0430 \u043F\u043E\u0437\u0438\u0446\u0438\u0438 " + this.pos + ".");
    };
    ...
    //КОД СЧИТЫВАЕТСЯ К НЕМУ ДОБАВЛЯЕТСЯ СЕМАНТИКА )))
    Parser.prototype.run = function (node) {
        var _this = this;
        if (node instanceof NumberNode_1.default) {
            return parseInt(node.number.text);
        }
        if (node instanceof UnarOperandNode_1.default) {
        ...
        if (node instanceof VariableNode_1.default) {
            if (this.scope[node.variable.text]) {
                ...
                throw new Error("\u041F\u0435\u0440\u0435\u043C\u0435\u043D\u043D\u0430\u044F \u0441 \u0442\u0430\u043A\u0438\u043C \u043D\u0430\u0437\u0432\u0430\u043D\u0438\u0435\u043C " + node.variable.text + " \u043D\u0435 \u043E\u0431\u043D\u0430\u0440\u0443\u0436\u0435\u043D\u0430");
            }
        }
        ...
        throw new Error('Ошибка, введите код, сударь!');
    };
    return Parser;
}());
